...
import static ru.chipmunkbarcode.barcodeTypes.Ean.calcDigit;
import static ru.chipmunkbarcode.barcodeTypes.Ean.validateAndPad;
import static ru.chipmunkbarcode.barcodeTypes.HumanReadableLocation.*;
...
public class Upc extends Symbol {
    ...
    protected void encode() {
        ...
        if (content.isEmpty()) {
            throw new BarcodeException("Missing UPC data");
        }
    ...
    private void separateContent() {
        ...
        if (splitPoint == -1) {
            ...
            throw new BarcodeException("Invalid add-on data");
        } else {
        ...
        switch (emode) {
            ...
            case '3':
                ...
                if (validate && (upce[3] == '0' || upce[3] == '1' || upce[3] == '2')) {
                    ...
                    throw new BarcodeException("Invalid UPC-E data");
                }
                break;
            case '4':
                upca[3] = upce[3];
    ...
    private static int getNumberSystem(String content) {
        switch (content.charAt(0)) {
            ...
            case '1':
                return 1;
            default:
                throw new BarcodeException("Invalid input data");
        }
    }
